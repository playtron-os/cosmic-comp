...
fn session_lock_elements<R>(
    ...
    // Our compositor-owned lock FADE-IN dissolves the live lock cover in at a rising alpha;
    // the normal locked state passes 1.0. Fed into the surface tree's alpha below.
    alpha: f32,
    blur_strength: usize,
